...
def handle_user_query(call):
    ...
    # ================= ЛОГИКА КНОПКИ РЕКЛАМЫ =================
        ...
        ads_text = (
            "🤖 <b>Авто-Консультант (Реклама):</b>\n"
            "Здравствуйте! Купить рекламу, посмотреть актуальные тарифы и скидки быстро и удобно можно тут: @PostGoldBot_bot.\n\n"
            "⚠️ <b>ВНИМАНИЕ:</b> Если ваш вопрос <b>не связан</b> с рекламной интеграцией, вам будет выписан штрафной страйк!\n\n"
            "<i>Если же у вас остались вопросы после посещения рекламного бота, или вам необходимы консультации, вы можете написать сообщение ниже, и администратор подключится к диалогу.</i>"
        )
        bot.send_message(call.message.chat.id, ads_text, parse_mode="HTML")
