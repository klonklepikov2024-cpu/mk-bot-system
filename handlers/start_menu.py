...
def handle_user_query(call):
    ...
    # ================= ЛОГИКА КНОПКИ РЕКЛАМЫ =================
        ...
        ads_text = (
            "🤖 **Авто-Консультант (Реклама):**\n"
            "Здравствуйте! Купить рекламу, посмотреть актуальные тарифы и скидки быстро и удобно можно тут: @PostGoldBot_bot.\n\n"
            "⚠️ **ВНИМАНИЕ:** Если ваш вопрос **не связан** с рекламной интеграцией, вам будет выписан штрафной страйк!\n\n"
            "_Если же у вас остались вопросы после посещения рекламного бота, или вам необходимы консультации, вы можете написать сообщение ниже, и администратор подключится к диалогу._"
        )
        bot.send_message(call.message.chat.id, ads_text, parse_mode="Markdown")
