...
4. ТРЕБОВАНИЕ: СТРОГО выбирай действие `tpl_18` (отправить шаблон). НИ В КОЕМ СЛУЧАЕ не пиши текст вручную и НЕ проси записать кружок на этом этапе! Просто отправь `tpl_18`."""
            ...
            behavior_rules = """3. СИСТЕМНЫЕ НАРУШЕНИЯ: СТРОГО выбирай `reply_text`. НЕ УПОМИНАЙ КРУЖОК! Напомни, что он заблокировал бота/сбежал. Основная цена разбана — строго 250⭐️. Как элитную альтернативу можешь надменно предложить ему сразу купить иммунитет (тег «Свободен») за 650⭐️, но базовый счет выставляй на 250."""
...
2. ДОЖИМ (ПРОДАЖА ШТРАФА): Если юзер спорит, возмущается ("это ошибка", "за что бан?") или не понимает причину -> выбирай `reply_text`. Четко и саркастично объясни, что система не ошибается. Озвучь сумму штрафа за его нарушение ({expected_fine}⭐️) и ОБЯЗАТЕЛЬНО закончи сообщение вопросом-крючком: "Будете оплачивать штраф или мне перевести вас на оператора?".
