...
- transfer_to_human: Перевести тикет на человека (применяй при тупике или отказе платить).
...
{{"reason": "твоя логика рассуждений по шагам", "action": "название_действия", "response_text": "твой УНИКАЛЬНЫЙ ответ юзеру (если action=reply_text)", "fine_amount": 0}}"""
