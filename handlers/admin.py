...
4. ПРОДАЖА (2000⭐️): Если юзер спорит или спрашивает как снять бан -> выбирай `reply_text`. НИ В КОЕМ СЛУЧАЕ НЕ УПОМИНАЙ ВИДЕО-КРУЖОК! Саркастично высмей его поведение. Штраф за наркотики максимальный — 2000⭐️. Озвучь ровно эту сумму и спроси, звать ли админа для оплаты."""
            ...
            behavior_rules = f"""3. ШАБЛОН: Для твоего типа ({ban_type.upper()}) используй нужный шаблон ('AGE' -> tpl_18, 'SPAM' -> tpl_flood).
4. ПРОДАЖА (650⭐️): Если юзер спорит или просит откупиться -> выбирай `reply_text`. НИ В КОЕМ СЛУЧАЕ НЕ УПОМИНАЙ ВИДЕО-КРУЖОК! Саркастично осади его. Сумма штрафа за это нарушение — 650⭐️. Предложи выставить счет."""
